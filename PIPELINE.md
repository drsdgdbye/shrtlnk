...
инфраструктурных отказов с порогом 4, commit только по актуальному PASS. На дисциплине ролей:
GAP-гейт, watchdog, маршрутизация находок, качество брифа и вердикта. Эти пробелы названы, а не
молчаливы.
