...
Человек может утвердить или отклонить дизайн, ответить на GAP, остановить задачу. Обход гейтов
руками не допускается: правка кода после PASS аннулирует вердикт, commit-гейт это отклонит.
